...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class Level : Singleton<Level>
	{
		...
		[Tooltip("Delay in seconds before attempting to find the player and camera after level generation.")]
		public float playerSearchDelay = 1f;
		...
		protected override void Awake()
		{
			...
			InitializeGame();
			InitializeLevel();
			Invoke(nameof(FindPlayerAndCamera), playerSearchDelay);
		}
		...
		/// <summary>
		/// Searches for the player and camera after a delay.
		/// </summary>
		protected virtual void FindPlayerAndCamera()
		{
			if (!m_player)
			{
				#if UNITY_6000_0_OR_NEWER
				...
				m_player = FindObjectOfType<Player>();
				#endif
				Debug.Log(m_player ? "Player found successfully." : "Player not found.");
			}
			...
			if (!m_camera)
			{
				...
				m_camera = FindObjectOfType<PlayerCamera>();
				#endif
				Debug.Log(m_camera ? "Camera found successfully." : "Camera not found.");
			}
		}
